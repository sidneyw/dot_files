...
_G.packer_plugins = {
  ...
  ["copilot-cmp"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/sidney/.local/share/nvim/site/pack/packer/opt/copilot-cmp",
