...
function! s:javascriptMonokaiPhoenixFiletype()
  ...
  hi jsCommentTodo guifg=#f8f8f8 guibg=NONE gui=NONE ctermfg=103 ctermbg=NONE cterm=NONE
  hi jsLineComment guifg=#778899 guibg=NONE gui=italic ctermfg=67 ctermbg=NONE cterm=italic
